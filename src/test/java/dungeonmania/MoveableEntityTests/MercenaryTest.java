...
public class MercenaryTest {
    ...
    public void ChaseMovement() {
        ...
        finalPosition = new Position(pos.getX() + 1, pos.getY() + 2);
        res = dmc.tick(Direction.DOWN);
    ...
    @Test
    @DisplayName("Test shortest path movement of mercenary chasing player")
    public void ShortestPathMovement() {
        /*
         *  [  ]   [  ]  wall  wall  wall  wall  wall
         *  [  ]   [  ]  [  ]  play  [  ]  [  ]  wall
         *  [  ]   [  ]  wall  [  ]  wall  [  ]  wall
        ...
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_mercenaryTest_shortestPath", "c_standard_movement");
        Position pos = getEntities(res, "mercenary").get(0).getPosition();
        ...
        movementTrajectory.add(new Position(x+1, y-2));
        movementTrajectory.add(new Position(x+1, y-3));
        
        // Assert Shortest Movement of Mercenary
        for (int i = 0; i <= 3; ++i) {
            res = dmc.tick(Direction.UP);
            assertEquals(movementTrajectory.get(nextPositionElement), getEntities(res, "mercenary").get(0).getPosition());
            nextPositionElement++;      
