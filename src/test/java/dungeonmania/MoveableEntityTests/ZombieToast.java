...
public class ZombieToast {
    ...
    public void randomMovementBlocked() {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_zombie_toastTest_randomMovement", "c_standard_movement");
        ...
        Position StationaryPos2 = new Position(pos2.getX(), pos1.getY());
        ...
        for (int i = 0; i <= 20; ++i) {
            ...
            assertEquals(StationaryPos2, getEntities(res, "zombie_toast").get(0).getPosition());
        }
    }
