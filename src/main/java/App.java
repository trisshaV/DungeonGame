    ...
    public void init() {
        ...
        Spark.post("/api/game/new/generate/", "application/json", (request, response) -> {
            return callUsingSessionAndArgument(request, (dmc) -> {
                try {
                    return dmc.generateDungeon(Integer.parseInt(request.queryParams("xStart")), Integer.parseInt(request.queryParams("yStart")), Integer.parseInt(request.queryParams("xEnd")), Integer.parseInt(request.queryParams("yEnd")), request.queryParams("configName"));
